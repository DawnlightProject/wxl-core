// wxl-graphics-fog: the core's table, the services the fog is built on, the config reader and the log.
...
namespace wxl::gfx::fog
{
    ...
    constexpr const char* kTag = "wxl-graphics-fog";
    constexpr const char* kConfigPath = "Extensions\\wxl-graphics-fog\\wxl-graphics-fog.cfg";

    /// Environment first, then Extensions\wxl-graphics-fog\wxl-graphics-fog.cfg.
...
#define FOG_LOG_DEBUG(...) ::wxl::gfx::fog::g_api->Log(WXL_LOG_DEBUG, ::wxl::gfx::fog::kTag, __VA_ARGS__)
#define FOG_LOG_INFO(...)  ::wxl::gfx::fog::g_api->Log(WXL_LOG_INFO,  ::wxl::gfx::fog::kTag, __VA_ARGS__)
#define FOG_LOG_WARN(...)  ::wxl::gfx::fog::g_api->Log(WXL_LOG_WARN,  ::wxl::gfx::fog::kTag, __VA_ARGS__)
#define FOG_LOG_ERROR(...) ::wxl::gfx::fog::g_api->Log(WXL_LOG_ERROR, ::wxl::gfx::fog::kTag, __VA_ARGS__)
